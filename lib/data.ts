  ...
  experience: [
    {
      period: "2024 — н.в.",
      description:
        "Сотрудничество с международными брендами, съёмки для каталогов и lookbook, участие в крупных рекламных кампаниях",
    },
    {
      period: "2019 — 2024",
      description:
        "Участие в показах Moscow Fashion Week, съёмки для глянцевых изданий, работа с ведущими дизайнерами и брендами",
    },
    {
      period: "2019 — 2022",
      description:
    ...
    },
    {
      period: "2015 — 2019",
      description:
        "Начало профессиональной карьеры: тестовые съёмки, сотрудничество с начинающими дизайнерами и фотографами, первые шаги в модельном бизнесе",
    },
  ],
  achievements: [
